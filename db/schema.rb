...
ActiveRecord::Schema.define(version: 2020_07_15_123143) do
  ...
  create_table "post_category_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "post_id", null: false
